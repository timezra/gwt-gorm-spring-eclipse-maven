 ...
 * </p>
 * <p>
 * This class is in the <code>shared</code> packing because we use it in both the client code and on the server. On the
 ...
 * not use native JavaScript. Code that is note translatable (such as code that interacts with a database or the file
